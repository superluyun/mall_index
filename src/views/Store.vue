  ...
  <div id='store'>
    ...
    <div class="search-breadcrumb width_center_1200">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item v-for="(v,i) in crumb.categories" :to="{ path: i==0?'/goodslist/cid1_'+v.id:'/goodslist/cid2_'+v.id }" :key="i">{{v.name}}</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    ...
    <div class="goods_where width_center_1200">
      <div class="goods_class" v-if="categories.length>0" ref='goods_class'>
        <ul class="float_left">
          ...
          <li class="float_left" v-for="(v,i) in categories" :key="i"><router-link :to="{ path: `/goodslist/cid2_${v.id}` }">{{v.name}}</router-link></li>
        </ul>
